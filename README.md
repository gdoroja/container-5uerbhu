...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-5uerbhu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-5uerbhu.containers.anotherwebservice.com/
...
```
git clone git@github.com:gdoroja/container-5uerbhu.git
cd container-5uerbhu
```
...
```
docker attach container-5uerbhu
```
